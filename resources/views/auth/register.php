...
<header>
    <a href="/login" class="back-link"><i class="fas fa-arrow-left"></i> Já tenho conta</a>
    <h1><i class="fas fa-pen-nib"></i> Kelps Blog</h1>
</header>
    ...
    <section class="auth-section">
        ...
        <form method="POST" action="/register">
            ...
            <div>
                ...
                <small>3–30 caracteres. Apenas letras, números e _</small>
            </div>
        ...
        <p><a href="/login">Já tem conta? <strong>Entrar</strong></a></p>
    </section>
</main>
