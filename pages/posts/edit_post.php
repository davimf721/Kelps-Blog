...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($column_exists) {
            $update_query = "UPDATE posts SET title = $1, content = $2, updated_at = NOW() 
                             WHERE id = $3 AND user_id = $4";
        } else {
            $update_query = "UPDATE posts SET title = $1, content = $2 
                             WHERE id = $3 AND user_id = $4";
        }
        
        $update_result = pg_query_params($dbconn, $update_query, [$title, $content, $post_id, $user_id]);
        ...
        <form method="POST" action="">
            ...
            <div class="editor-container">
                <div class="editor">
                    ...
                    <textarea id="content" name="content" required placeholder="Cole imagens aqui ou use a barra de ferramentas..."><?php echo htmlspecialchars($post['content']); ?></textarea>
