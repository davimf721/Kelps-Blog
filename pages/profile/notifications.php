...
$mark_read = pg_query_params($dbconn, 
...
$update_counter = pg_query_params($dbconn, "UPDATE users SET unread_notifications = 0 WHERE id = $1", [$user_id]);

// Obter todas as notificações do usuário (mais recentes primeiro)
$notifications_result = pg_query_params($dbconn, 
