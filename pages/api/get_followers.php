...
// Buscar seguidores (pessoas que seguem este usuário)
$query = "
...
if (!$result) {
    echo json_encode(['success' => false, 'message' => 'Erro ao buscar seguidores']);
    exit;
}
...
while ($row = pg_fetch_assoc($result)) {
    ...
    // Verificar se o usuário atual segue este seguidor
